...
struct FragmentShaderArguments {
  ...
  device float *frequency_3[[id(3)]];
  device float *sync_4[[id(4)]];
  device float *offset_5[[id(5)]];
  device float *angle_6[[id(6)]];
  device float *speed_7[[id(7)]];
};
...
float frequency_3 = args.frequency_3[0];
float sync_4 = args.sync_4[0];
float offset_5 = args.offset_5[0];
float angle_6 = args.angle_6[0];
float speed_7 = args.speed_7[0];
         
  out.write(
    osc(rotate(st, angle_6, speed_7, time), frequency_3, sync_4, offset_5, time)
  ,gid);
}
