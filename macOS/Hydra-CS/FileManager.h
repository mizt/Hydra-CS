namespace FileManager {
    ...
    NSString *deleteLastPathComponent(NSString *filename) {
        return [filename stringByDeletingLastPathComponent];
    }

    NSString *appendingPathComponent(NSString *filename, NSString *str) {
        return [filename stringByAppendingPathComponent:str];
    }
